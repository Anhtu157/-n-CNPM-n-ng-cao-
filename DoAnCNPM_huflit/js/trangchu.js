window.onload = function () {
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('NỔI BẬT NHẤT', green, ['star=3', 'sort=rateCount-decrease'], soLuong);
		addKhungSanPham('SẢN PHẨM MỚI', green, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong);
		addKhungSanPham('TRẢ GÓP 0%', green, ['promo=tragop'], soLuong);
		addKhungSanPham('GIÁ SỐC ONLINE', green, ['promo=giareonline'], soLuong);
		addKhungSanPham('GIẢM GIÁ LỚN', green, ['promo=giamgia'], soLuong);
